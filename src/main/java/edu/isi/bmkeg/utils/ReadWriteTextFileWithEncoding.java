...
public final class ReadWriteTextFileWithEncoding {
	...
	public static void write(String fFileName, String fEncoding, String text)
			throws IOException {

		Writer out = new OutputStreamWriter(
				new FileOutputStream(fFileName),
				fEncoding);
	...
	public static String read(String fFileName, String fEncoding)
			throws IOException {
